                                        ...
                                        <tr> 
                                          <td class="member-card block_11f26 center_11f26 padding_bottom_lee1z full-width_fa11fjf1" width="300" height="155" valign="top" style="background-image: url(${cardBackgroundURL});background-repeat:no-repeat;background-position: center bottom;background-size:300px;color: #000000;font-family: 'Open Sans', Arial, sans-serif;font-size: 14px;line-height: 18px;"> 
                                            ...
                                            <table align="bottom" width="100%" cellpadding="0" cellspacing="0" style="width:100%;"> 
                                              <tbody>                                                 
                                                <tr> 
                                                  <td class="extra-space2 ${cardUpperSpacerHeightClass}" style="line-height: 1px; font-size: 1px;" height="${cardUpperSpacerHeight}">&nbsp;</td> 
                                                </tr> 
                                                <tr> 
                                                  <td class="member-card-text" style="padding-left:36px;text-align: left;"> 
                                                ...
                                                <tr> 
                                                  <td class="member-card-text" style="padding-left:36px;text-align: left;font-family: 'Open Sans', Arial, sans-serif;font-weight: bold;;color:#3d3d3d;"> 
...
#if( $membershipType.contains("A"))                 
                                                <tr> 
                                                  <td class="member-card-text" style="padding-left:36px;text-align: left;font-family: 'Open Sans', Arial, sans-serif;"> 
...
<tr> 
                                          ...
                                          <![endif]--> </td> 
                                          <td valign="top" class="block_11f26" style="background-color: #FFFFFF;padding: 0px 10px 0px 22px;"> 
                                            <table role="Member Module Renewal Information" style="width: 100%; border-collapse: collapse;margin:0 auto;" border="0" cellpadding="0" cellspacing="0" width="100%" align="center"> 
                                              ...
                                              <!-- Extra space -->                                                 
...
#if( $membershipType.contains("A"))                                                  
                                                <tr> 
                                                  <td valign="top" style="font-family:'Open Sans',arial,sans-serif,helvetica;font-size:13px;font-weight:normal;mso-line-height: exactly;line-height:18px;color:#3d3d3d;vertical-align:top;text-align:left;"> 
                                                    <div class="mktoText" id="body2-para" mktoname="Paragraph">
                                                      <p style="font-family: 'Open Sans',arial,sans-serif,helvetica; font-size: 14px; font-weight: normal; color: #3d3d3d; vertical-align: top; text-align: left; padding:5px 0 4px 0;"><span face="Open Sans, arial, helvetica, sans-serif" style="font-family: 'Open Sans', arial, helvetica, sans-serif;"> <strong>${lead.FirstName}, thank you for being a member since ${memberStartYear}!</strong> </span></p> 
#if($renewalStatus == "1" || $renewalStatus == "2" && !$membershipType.contains("L") )                                                    
                                                      <p style="font-family: 'Open Sans',arial,sans-serif,helvetica; font-size: 13px; font-weight: normal; color: #3d3d3d; vertical-align: top; text-align: left; padding: 10px 0 15px 0;"><span face="Open Sans, arial, helvetica, sans-serif" style="font-family: 'Open Sans', arial, helvetica, sans-serif;">Your membership is up for renewal on <strong>${formattedParagraphRenewalDatemember}. </strong> </span> <br></p>
                                                ...
                                                <tr> 
                                                  <td valign="top" style="font-family:'Open Sans',arial,sans-serif,helvetica;font-size:13px;font-weight:normal;mso-line-height: exactly;line-height:18px;color:#3d3d3d;vertical-align:top;text-align:left;"> 
                                                    <div class="mktoText" id="body2-para" mktoname="Paragraph">
                                                      <p style="font-family: 'Open Sans',arial,sans-serif,helvetica; font-size: 14px; font-weight: normal; color: #3d3d3d; vertical-align: top; text-align: left; padding: 0 0 15px;"><span face="Open Sans, arial, helvetica, sans-serif" style="font-family: 'Open Sans', arial, helvetica, sans-serif;"> <strong>${lead.FirstName}, thank you for being a member since ${memberStartYear}!</strong></span></p> 
                                                ...
                                                <tr> 
                                                  <td valign="top" style="font-family:'Open Sans',arial,sans-serif,helvetica;font-size:13px;font-weight:normal;mso-line-height: exactly;line-height:18px;color:#3d3d3d;vertical-align:top;text-align:left;padding-top:15px;"> 
                                                    <div class="mktoText" id="body2-para" mktoname="Paragraph">
                                                      <p style="font-family: 'Open Sans',arial,sans-serif,helvetica; font-size: 14px; font-weight: normal; color: #3d3d3d; vertical-align: top; text-align: left; padding: 0px;"><span face="Open Sans, arial, helvetica, sans-serif" style="font-family: 'Open Sans', arial, helvetica, sans-serif;"> You have paid $${amountPaid} toward your pledge of $${amountTotal}, becoming a paid-in-full life member.  Your last payment will be in ${lifeInstallmentStop}.</span></p> 
